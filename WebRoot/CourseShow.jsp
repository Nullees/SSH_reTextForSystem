   ...
   <a href="studentfindobjectbyname.action?s_no=<s:property value='#student.s_no'/>">上传作业</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <center>
    	...
    	<table border="1">
    		...
    		<s:iterator value="#request.courseall" id="course">
    			<tr>
    				...
    				<!--  <td><a href="flightdelete.action?f_id=<s:property value='#flight.f_id'/>">删除</a></td>-->
    				<td><a href="locationaddc_noandt_no.action?c_no=<s:property value='#course.c_no'/>&t_no=<s:property value='#course.t_no'/>&s_no=<s:property value='#student.s_no'/>">选课</a></td>
    			</tr>
    		</s:iterator>
