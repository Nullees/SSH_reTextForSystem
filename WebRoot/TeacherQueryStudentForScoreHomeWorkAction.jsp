  ...
  <s:iterator value="#request.tea" id="teacher">
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <center>
    	...
    	<s:iterator value="#request.stu" id="student"> 
    	<tr>
    	 <td><s:property value="#student.s_name"/></td>
    	 <td><s:property value="#student.s_college"/></td>
    	 <td><s:property value="#student.s_department"/></td>
    	 <td><a href="locationshowtargetbys_no.action?s_no=<s:property value='#student.s_no'/>&t_no=<s:property value="#teacher.t_no"/>">输入学生成绩</a></td>
    	 </tr>
    	 </s:iterator>
    	</table>
   </center>
