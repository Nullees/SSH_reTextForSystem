...
<html>
  ...
  <body>
    ...
    <hr>
     ...
     <center>
     <h2>请输入公告内容</h2>
    	<s:form action="officeaddnotice.action" method="post">
    		<s:textfield name="o_no" label="管理员编号" value="50001"></s:textfield>
    		<s:textarea name="o_notice" label="公告内容"></s:textarea>
