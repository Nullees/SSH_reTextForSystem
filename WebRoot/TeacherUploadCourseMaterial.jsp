...
<html>
  ...
  <hr/>
   ...
   <center>
    	<h1>教师上传课程资料文件</h1>
    		<form action="teacheruploadcoursematerial.action?t_no=<s:property value="#teacher.t_no"/>" method="post" enctype="multipart/form-data"> 
   			课程资料文件标题：<input type="text" name="title"><br />
