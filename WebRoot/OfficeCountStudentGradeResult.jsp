...
<html>
  ...
  <body>
    ...
    <hr>
     ...
     <center>
    	<s:iterator value="#request.stu" id="student"></s:iterator>
    	<s:iterator value="#request.tea" id="teacher"></s:iterator>
    	<s:iterator value="#request.cou" id="course"></s:iterator>
    	<s:iterator value="#request.loc" id="location"></s:iterator>
    	<h2>学生成绩</h2>
    	您好，经过查询，该学生:<font color="red"><s:property value="#student.s_name" /></font>
    	<br />
    	所选课程：<font color="red"><s:property value="#course.c_name" /></font>
    	<br />
    	任课教师：<font color="red"><s:property value="#teacher.t_name" /></font>
    	<br />
    	成绩为：<font color="red"><s:property value="#location.l_grade" /></font>
    	<br />
    	学年：<font color="red"><s:property value="#location.l_year" /></font>
    	<br />
    	学期：<font color="red"><s:property value="#location.l_term" /></font>
    	<br />
    	是否重修:<font color="red"><s:property value="#location.l_rebulid" /></font>
    </center>
